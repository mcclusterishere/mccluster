...
export async function executeAdapter(sourceKey, input = {}, env = {}) {
  ...
  switch (sourceKey) {
    ...
    case 'equity_uprise':
    case 'scsu_docket':
      return executeHouseAdapter(sourceKey, input, env);
    default:
...
export function adapterCapabilities() {
  return {
    persistent: ['usgs', 'open_meteo', 'celestrak', 'adsb_lol', 'overpass', 'launch_library2', 'grants_gov', 'usaspending', 'nhtsa', 'census', 'fred', 'bls', 'eia', 'data_commons', 'nasa_firms', 'copernicus', 'planet_research', 'radio_browser', 'gbfs', 'house', 'equity_uprise', 'scsu_docket'],
