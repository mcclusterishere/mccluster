...
> Filename note: the historical `LOBBY-INTAKE` filename is retained temporarily for link stability; it does **not** control the semantic identity.  
...
One secondary line such as **ARRIVAL + ORIENTATION** or a small directory is acceptable.
