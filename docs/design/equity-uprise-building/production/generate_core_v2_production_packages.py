...
for level in programs["levels"]:
    ...
    if n==6:
        fixtures.append({"id":"halo_globe_soft_emission","type":"object_emission","temperature_k":5200,"intensity_relative":0.18,"position_ft_local":{"x":55,"y":12,"z":8.25},"rule":"Subtle only; must not turn Penthouse Command into a tactical command center."})
