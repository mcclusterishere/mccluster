# Level 06 — Penthouse Command — Core V2 Production Package
...
- `../../references/floor-06/equity-uprise-floor-06-penthouse-command-core-v2-schematic-v1.dxf`
- `../../references/floor-06/equity-uprise-floor-06-penthouse-command-core-v2-schematic-v1.svg`
- `../../references/floor-06/equity-uprise-floor-06-penthouse-command-core-v2-schematic-v1.png`
