...
function classifyFamily(lab, datasets) {
  ...
  if (distributedById) {
    return { family: "DISTRIBUTED_TECHNICAL", definition: distributedById, canonical_id: distributedById.scenario_id };
  }
  ...
  if (distributedBySource.length > 1) {
    throw new LabRuntimeError(
      "VIEWER_DISTRIBUTED_SCENARIO_AMBIGUOUS",
      "multiple building labs use source lab " + lab + "; use a distributed scenario_id"
    );
  }
