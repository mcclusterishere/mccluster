...
Floor 6 spatializes the highest-level institutional view already present across Equity Uprise.

### `equity-uprise.html` — Institutional Desk

The public-facing institutional desk is already organized around three high-level states:

1. **NOW**
   - current public-affairs/policy-intelligence work;
   - live infrastructure/data-center governance work;
   - current research and working-paper architecture;
   - current institutional activity.

2. **PAST WORK**
   - Docket 516/516R;
   - prior campaign/media work;
   - October 5 convening;
   - policy memo programs;
   - infrastructure work;
   - credential/proof records.

3. **JOIN**
   - fellows;
   - organizations;
   - operators/developers/utilities/builders/suppliers;
   - residents/environmental/ratepayer groups;
   - foundations/universities/neutral institutions;
   - live-issue intake.

Those three states define the public-facing identity of Floor 6.

### `eu-status`, `eu-control`, monitoring and publication systems

The repo also contains internal systems for:
- integration health;
- jobs;
- monitors;
- approvals;
- commands;
- publication state;
- fellowship/interview queues;
- control-plane actions.

These justify a secure back-of-house systems/support layer.

They **do not** justify turning the public Floor 6 environment into an exposed operations dashboard.

### Boundary with other floors

- Floor 2 owns public conversation.
- Floor 3 owns fellows/network/opportunities.
- Floor 4 owns media/culture.
- Floor 5 owns research/evidence/publication review.
- Floor 6 owns the **institutional overview and directional layer**.

Floor 6 summarizes and routes; it does not duplicate the detailed workspaces below.

---

## 2. Relationship to Level 7 roof

Floor 6 is explicitly **not a dead-end top floor**.
...
- vertical circulation to the roof;
- Stair A and Stair B continuity;
- a plausible elevator/roof-access strategy if later permitted;
- MEP/riser termination;
- roof-access control/wayfinding;
- structural/service coordination for the roof;
- a clear digital transition to the rooftop mobility portal.

The roof itself remains a separate Level 7 environment.

---

## 3. Architectural intent

Floor 6 should feel like:
- the quietest and most resolved interior level;
- a compact institutional command/overview floor;
- refined, serious, and calm;
- suitable for strategic review and high-level guests;
- clearly connected to the rest of the building;
- one step below the open-air roof departure experience.
...
Floor 6 has:
- **no ground/public exterior entrance**;
- **no balcony**;
- **no terrace**;
- **no random exterior door in the 360 perimeter**.

The south and exposed perimeter remain sealed upper-floor glazing/windows.

Roof access occurs through the vertical/core system, not through a perimeter terrace door.

---

## 6. Canonical 360 coordinate system
...
### 0° / north-forward
The **Penthouse Command table** and **PENTHOUSE COMMAND** identity wall with:
- NOW
- PAST WORK
- JOIN

### +90° / east-right
The fixed elevator/core plus **Roof Access / Mobility Transition** terminal and visible upward-wayfinding logic.
...
## 7. Central Penthouse Command zone
...
### Command table
Use one refined shared table:
- approximately **16' × 5'**;
- center approximately **(36,41)**;
- **6 seats maximum**;
- one accessible position;
- concealed power/data via real floor service.

The table supports:
- top-level institutional briefings;
- current-work overview;
- priority review;
- partner/guest orientation;
- high-level direction.

It is not a giant interactive command table.

---

## 8. Penthouse Command identity wall
...
### NOW may show
- current live initiatives;
- current research/public-affairs work;
- current institutional direction;
- high-level status summaries.

### PAST WORK may show
- verified prior work;
- selected institutional history;
- links downward to Policy + Proof.
...
The wall must not expose raw admin/control data or private information.
...
Purpose:
- partner/guest conversation;
- institutional introductions;
- high-level collaboration discussion;
- explaining participation pathways;
- waiting before/after a briefing.
...
One restrained partner/join information surface is acceptable.

Do not duplicate the full fellowship/network floor.

---

## 10. Strategy Review Room
...
Function:
- focused strategic review;
- current issue prioritization;
- internal direction-setting;
- small confidential meetings.
...
## 11. Partner / Executive Briefing Room
...
Function:
- partner briefings;
- foundation/university/operator meetings;
- organizational collaboration discussions;
- high-level overview presentations.
...
## 12. Roof Access / Mobility Transition terminal

One slim terminal adjacent to the elevator/core:
- approximate footprint **X 49–51 / Y 24–29**

Functions may include:
- **CONTINUE TO ROOF / LEVEL 7**;
- rooftop access state;
- destination preview;
- mobility-portal routing;
- floor directory;
- return to lower levels.

This terminal is the **interior digital handoff** to Level 7.

It does not replace physical code-compliant roof access.

No destination domain or building should be permanently baked into the architecture; future destinations should be data-driven.
...
### Primary
Elevator → command table:
- approximately **6 ft clear**.

Command table → north support/core:
- approximately **6 ft clear**.

Command table → roof-transition terminal:
...
Do not clutter the main circulation field.
...
- step-free Floor 6 routes;
- accessible command-table position;
- accessible salon seating;
- accessible Strategy/Briefing rooms;
- accessible roof-transition terminal;
- accessible restroom concepts;
- visual/audible life-safety notification.

Level 7 accessibility must be resolved in the roof design.
...
- vertical roof-access continuity;
...
Final occupancy, roof access, travel distance, stair/door ratings, elevator behavior, and life-safety systems require professional code analysis.

---

## 19. Structure / roof consequence

Floor 6 sits directly below the roof and therefore must coordinate with:
- roof slab/deck;
- rooftop mechanical/support loads;
- parapet/crown;
- roof-access enclosure;
- future candidate helipad/mobility-zone feasibility.

No schematic or render may claim that the structure is already rated for helicopter operations.

Heavy rooftop aviation loads require separate structural design.

---

## 20. Material palette

Continue the established Equity Uprise family, with slightly more refinement.

### Floor
- honed dark-gray stone/concrete/commercial porcelain;
- optional restrained rug under salon seating.

### Walls
- charcoal mineral finish;
- blackened/brushed gunmetal steel;
- smoked/clear glass;
- restrained warm wood;
- integrated display surfaces.

### Red accent
Use minimally:
- current-state indicator;
- roof/vertical-wayfinding detail;
- thin architectural reveal.

No full-room red glow.
...
### Main command zone
- quiet architectural ceiling;
- one restrained linear/rectangular fixture aligned to table;
- warm-neutral task/ambient lighting.

### Salon
- softer warm lighting.

### Enclosed rooms
- dimmable task/briefing lighting.

### Core / roof transition
Subtle upward wayfinding may use restrained red/white guidance.

General appearance:
- approximately **2700–3000K**;
...
- acoustic ceiling;
- wall absorption;
- sealed Strategy/Briefing room doors;
- low-noise HVAC;
- upholstered salon furniture.

The command area should support confidential small-group conversation without becoming acoustically dead.

---

## 23. Technology / power / data

Provide plausible services for:
- Penthouse Command wall;
- command table;
- join/partner surface;
- Strategy Review Room;
- Partner / Executive Briefing Room;
...
Primary:
- north PENTHOUSE COMMAND wall.

Secondary:
- Floor 6 identifier near elevator;
- subtle LEVEL 7 / ROOF wayfinding at the core.

Do not:
- redraw/crop the mark;
- use HM branding;
- invent government seals;
- invent slogans.

---

## 25. Canonical visible furniture

- one 16' × 5' command table;
- 6 command chairs maximum;
- one compact salon sofa/bench;
- two salon chairs;
- one salon table;
- one Strategy Review table + 4 chairs;
- one Partner/Executive Briefing table + 4–6 chairs;
...
## 26. Canonical 360 panorama requirements
...
- no visible exterior terrace access.
...
- invented website destinations.

---

## 27. Hotspot logic

Suggested Floor 6 hotspots:

1. **NOW** → current institutional work.
2. **PAST WORK** → verified record / lower-floor proof.
3. **JOIN** → participation pathways.
4. **Command table** → institutional overview.
...
## 28. Content-authenticity / political-neutrality rule

The main wall summarizes existing Equity Uprise material.
...
- turn contested political analysis into permanent architectural fact.

Current institutional work and past-work records must come from the live repo/data system.

The architecture itself does not endorse a political side.

---

## 29. Floor 6 identity in one sentence

**A calm institutional overview floor where Equity Uprise's current work, verified record, and participation pathways converge before the user continues upward to the Level 7 rooftop mobility portal.**
