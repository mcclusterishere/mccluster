...
Creator/edit rooms are internal rooms inside the south facade line.

---

## 4. Central Media / Listening Room

### Planning zone
- approximately **X 24–48 / Y 28–50**

### Seating
Canonical flexible seating footprint:
- approximately **X 29–43 / Y 34–43**
- maximum 8 seats in daily configuration
...
## 5. Culture Archive / Rally Gallery

Planning zone:
- **X 2–18 / Y 18–38**

Includes:
- one gallery/display wall;
- one compact bench/sofa;
- two chairs;
- one small table.

Keep 4–6 archive frames/screens maximum in the canonical scene.

---

## 6. Creator Recording Room

- **X 2–15 / Y 4–16**
- approximately 13' × 12'

Program:
- one microphone/capture position;
...
Program:
- one two-person editing desk;
- primary display;
- two visitor/review seats;
- acoustic treatment.
...
as clear elevator/core approach.

Maintain approximately 6 ft clear in front of elevator.
...
### Primary
Elevator → central media room:
- approximately **6 ft clear**.

Media room → north support/stairs:
- approximately **6 ft clear**.
...
Media room → recording/edit rooms:
- at least approximately **4 ft clear**, with clear accessible approaches.
...
### Listening / screening seating
Use a simple low seating cluster within approximately:
- **X 29–43 / Y 34–43**

Maximum 8 seats total.
...
### Recording room
- small work surface approximately 5' × 2'
- one microphone/capture position
- two seats maximum

### Edit suite
- desk approximately 8' × 3'
- two work positions
- two review seats
...
- media wall services from Media/Music IT;
- gallery displays route through wall/floor pathways;
- central playback seating may use floor boxes only if shown/routed;
...
At schematic level:
- central media room receives acoustic ceiling/wall treatment;
- recording room requires acoustic isolation strategy;
- edit suite requires controlled reflection strategy;
- gallery/lounge remains quieter than a hard-surface corridor;
- HVAC noise must be controlled.

Final isolation assemblies require professional acoustic design.

---

## 16. Egress / code limitations
