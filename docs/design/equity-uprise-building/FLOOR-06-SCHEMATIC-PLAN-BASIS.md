...
Floor 6 has:
- no public exterior door;
- no balcony;
- no terrace.

South facade:
- sealed upper-floor glazing/window system.

Roof access occurs through vertical circulation/core, not perimeter doors.

---

## 4. Central Penthouse Command zone

### Planning zone
- approximately **X 22–50 / Y 28–50**
...
- two chairs;
- one small table;
- one restrained Join/Partner surface.

---

## 6. Strategy Review Room
...
## 7. Partner / Executive Briefing Room
...
## 8. Roof Access / Mobility Transition terminal

- approximate footprint **X 49–51 / Y 24–29**
- adjacent to elevator/core
- must not obstruct elevator approach

Functions:
- Level 7 transition;
- roof access state;
- destination/mobility preview;
- floor navigation.
...
## 9. Elevator lobby / upward-transition field
...
Preserve a legible upward-transition route from the core toward Level 7 access.
...
### Primary
Elevator → Command zone:
- approximately **6 ft clear**.

Command zone → north/core:
- approximately **6 ft clear**.

Command zone → Level 7 transition terminal:
...
Command zone → Strategy/Briefing rooms:
- at least approximately **4 ft clear** with accessible approaches.
...
Orientation:
- **0° north:** command table + NOW / PAST WORK / JOIN wall
- **+90° east:** elevator + Roof Access / Mobility terminal
- **180° south:** Strategy + Partner rooms + sealed glazing
- **-90° west:** Institutional Salon / Join Lounge

---

## 14. Furniture geometry
...
- roof-transition terminal through core-side service;
- Level 7 destination registry remains data-driven;
- MEP/roof-service zone remains vertically open for roof coordination.

---

## 16. Egress / roof/code limitations

This schematic preserves:
- two protected stairs;
- fixed elevator/core;
- roof-access continuity;
- stacked services;
- open circulation.
...
- occupant load;
- final roof access;
- elevator roof service;
- exit separation/travel distance;
- stair sizing;
- wall/door ratings;
- sprinkler/fire-alarm design;
- structural roof/aviation loads;
...
- [ ] fixed Stair A
- [ ] fixed Stair B
- [ ] fixed MEP/roof-service stack
- [ ] roof vertical-continuity reservation
- [ ] no exterior public door
- [ ] no balcony/terrace
- [ ] 16' × 5' command table
- [ ] one suspended Halo Globe at (41,22), radius 2.25 ft, center 8.25 ft AFF
- [ ] Halo Globe coordination envelope occupies the open southeast-central pocket and clears briefing-room fronts, command furniture, roof terminal, fixed core and primary circulation
- [ ] NOW / PAST WORK / JOIN wall
- [ ] Institutional Salon west
- [ ] Strategy Review south
- [ ] Partner / Executive Briefing south
- [ ] roof-transition terminal by elevator
