...
- Floor 1 remains the modeled level of exit discharge at 0'-0".
...
- **Tunnel Operations Concourse / Security Gate — X20–48 / Y54–64**
...
- incident status;
- connected-building route availability;
...
The north-side transfer lock forms the controlled boundary between B1 and the tunnel backbone.

It represents:

- security interlock;
- environmental/fire separation;
- vehicle/personnel transfer;
- emergency isolation;
- closed/locked/failed states;
- access audit.
