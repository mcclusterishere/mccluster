...
> Branch audited: `architecture/equity-uprise-core-v2`  
...
|---|---:|---|
| Repo-source classification | **254 sources classified** | Current source ledger contains 102 capability sources and 152 explicitly support/development-authority sources. The exact discovered-set gate remains enforced by `verify_equity_uprise_repo_sources.py`. |
