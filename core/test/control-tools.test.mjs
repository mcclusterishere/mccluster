...
import { CONTROL_TOOLS, callControlTool } from '../src/tools/control.mjs';
...
test('ontology mutation fails closed without signed actor context', async () => {
  await assert.rejects(
    () => callControlTool('core.ontology.action.apply', {
